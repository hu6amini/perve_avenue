(()=>{
    ...
    // Track if we're already optimizing to prevent recursion
    ...
    Element.prototype.setAttribute=function(e,t){
        if(!isOptimizing && (e==="src"||e==="srcset")&&c(this)){
            // Use a microtask to avoid recursion while setting attributes
