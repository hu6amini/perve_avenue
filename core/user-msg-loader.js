...
whenBodyReady(() => {
    ...
    async function loadLightGallery() {
        const LIGHTGALLERY_CSS = [
            "https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@319c893b41f63e37be67e0445777f38f8b1deb35/lightgallery@2.7.1/lightgallery.min.css",
        ...
        try {
            ...
            const loadEnhancements = async () => {
                ...
                const results = await Promise.allSettled([
                    ...
                    loadScript("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@d9a6775f680dd4781176d4ecb4c01d5f1c70763e/modules/messenger.js")
                ]);
