...
whenBodyReady(() => {
    ...
    async function loadLightGallery() {
        const LIGHTGALLERY_CSS = [
            "https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@dbbfc84d97af91286a7a5e5de954a299b07897bd/lightgallery@2.7.1/lightgallery.min.css",
        ...
        try {
            ...
            const loadEnhancements = async () => {
                ...
                const results = await Promise.allSettled([
                    ...
                    loadScript("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@0d0430320bcf69473d5d271b0b46724d2885f7f8/modules/posts.min.js"),
                    ...
                    loadScript("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@6a9e5a73ac59d2fa760a9db43912b3b038ab68c4/modules/messenger.js")
                ]);
