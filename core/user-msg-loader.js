...
whenBodyReady(() => {
    ...
    async function loadLightGallery() {
        const LIGHTGALLERY_CSS = [
            "https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@28cd56dae473843985d367e29ca071a3db6a0ee7/lightgallery@2.7.1/lightgallery.min.css",
        ...
        try {
            ...
            const loadEnhancements = async () => {
                ...
                const results = await Promise.allSettled([
                    ...
                    loadScript("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@1a7358a1df99cfacf7636b63428b18e571bc169b/modules/messenger.js")
                ]);
