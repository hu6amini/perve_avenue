...
async function loadLightGallery() {
    const LIGHTGALLERY_CSS = [
        "https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@12fc0dad5f8d6023e13c298f36be220787934a2f/lightgallery@2.7.1/lightgallery.min.css",
    ...
    try {
        ...
        const loadEnhancements = () => {
            ...
            Promise.allSettled([
                ...
                loadScript("https://cdn.jsdelivr.net/gh/hu6amini/perve_avenue@aa497958c6401b762411008a30741c34ec1df00d/modules/messenger.js")
            ]).then(results => {
                const failed = results.filter(r => r.status === 'rejected');
                if (failed.length > 0) {
